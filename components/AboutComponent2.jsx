...
const AboutComponent2 = () => {
  return (
    <div className="flex m-14 mb-0 lg:mx-28 xl:mx-36 2xl:mx-52 flex-col justify-center text-center items-center text-black">
      <h1 className="md:text-3xl z-10 text-xl font-bold">Hvem er vi s</h1>
      <div className="bg-[hsl(197,100%,50%)] mb-10 z-0 -mt-2 py-1.5 md:px-24 px-12 border-none"></div>
      {about.map((item) => {
        ...
        return (
          ...
          >
            ...
            >
              <h1 className="lg:text-2xl z-10 md:text-2xl text-base font-bold">
                {name}
              </h1>
              <div className="bg-[#00B8FF] z-0 -mt-2 py-1.5 md:px-28 px-20 border-none"></div>
              <p
                className="md:m-10 m-5 lg:text-2xl"
                style={{ fontFamily: "Quintessential" }}
              >
                {position}
              </p>
              <div className="lg:text-2xl text-center p-2 text-[10px] sm:text-sm md:text-base">
                <p>{about1}</p>
            ...
            <img
              ...
              src={image}
              className={`rounded-xl sm:rounded-none object-center sm:object-top object-cover w-full max-h-[300px] min-w-[100px] sm:max-h-[700px] ${
